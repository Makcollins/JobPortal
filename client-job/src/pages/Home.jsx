...
const Home = () => {
  ...
  const filteredData = (jobs, selected, query) => {
    ...
    // category filtering
    if (selected) {
      filteredJobs = filteredJobs.filter(({ location, company_name,detected_extensions }) => (
        location.toLowerCase() === selected.toLowerCase() ||
        detected_extensions.qualifications.toLowerCase() === selected.toLowerCase() ||
        detected_extensions.posted_at >= selected ||
        company_name.toLowerCase() === selected.toLowerCase() ||
        detected_extensions.schedule_type.toLowerCase() === selected.toLowerCase()
  ...
  // 51011da31c7fff6d9edc54a0301ce5e3 api-key
