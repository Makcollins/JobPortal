  ...
  return (
    <div>
        <div className='mb-20'>
            ...
            <p className='text-primary/75 text-base mb-4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi consectetur magni eos possimus, ea optio!</p>
            <div className='w-full space-y-4'>
                <input type="email" name="email" id="email" placeholder='example@mail.com' className='w-full block py-2
